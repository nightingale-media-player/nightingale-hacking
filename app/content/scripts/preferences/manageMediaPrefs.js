...
var manageMediaPrefsPane = {
  ...
  doPaneLoad: function manageMediaPrefsPane_doPaneLoad() {
    ...
    function forceCheck(event) {
      ...
      var mediaMgmtSvc = Cc["@getnightingale.com/Nightingale/media-manager-service;1"]
  ...
  doDisplayPreview: function() {
    ...
    var manageMode = 0;
    if (Application.prefs.getValue("nightingale.media_management.library.copy", true)) {
      manageMode |= Ci.sbIMediaFileManager.MANAGE_COPY;
    }
    if (Application.prefs.getValue("nightingale.media_management.library.move", true)) {
    ...
    WindowUtils.openModalDialog(window,
                                "chrome://nightingale/content/xul/manageMediaPreview.xul",
  ...
  get _defaultLibraryFolder() {
    var baseFile = Cc["@getnightingale.com/Nightingale/DownloadDeviceHelper;1"]
