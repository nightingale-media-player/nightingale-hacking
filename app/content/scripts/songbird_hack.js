...
function SBDroppedEntry()
{
  if ( theDropIsDir )
  {
    ...
    if (!_drop_library || !_drop_query) {
      _drop_library = Components.classes[SONGBIRD_MEDIALIBRARY_CONTRACTID].createInstance(SONGBIRD_MEDIALIBRARY_IID);
      _drop_query = Components.classes[SONGBIRD_DATABASEQUERY_CONTRACTID].createInstance(SONGBIRD_DATABASEQUERY_IID);
