...
function CoreMPLAYER()
{
  ...
  this._verifyObject = function() {
    ...
    {
      LOG("VERIFY OBJECT FAILED.  OBJECT DOES NOT HAVE PROPER MPLAYER API.")
...
/**
  ...
  */
function CoreMPLAYERDocumentInit( id )
{
  try
  {
...
{
  LOG( "\n!!! coreMPLAYER failed to load properly\n" + err );
}
