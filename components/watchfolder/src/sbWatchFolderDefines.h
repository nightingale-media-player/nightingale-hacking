...
#define PREF_WATCHFOLDER_ROOT        "nightingale.watch_folder."
#define PREF_WATCHFOLDER_ENABLE      "nightingale.watch_folder.enable"
#define PREF_WATCHFOLDER_PATH        "nightingale.watch_folder.path"
#define PREF_WATCHFOLDER_SESSIONGUID "nightingale.watch_folder.sessionguid"
