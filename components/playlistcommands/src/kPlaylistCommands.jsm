...
var kPlaylistCommands = {
  ...
  MEDIALIST_DEVICE_LIBRARY       : "devicelibrary@playlistcommands.getnightingale.com",
  MEDIALIST_CDDEVICE_LIBRARY     : "cddevicelibrary@playlistcommands.getnightingale.com"
}
