...
// SB_DEVICE_CONTROLLER_CATEGORY "songbird-device-controller"
static const mozilla::Module::CategoryEntry kDeviceMarshallCategories[] = {
  ...
  { SB_DEVICE_CONTROLLER_CATEGORY, SB_CDDEVICE_CONTROLLER_CLASSNAME, SB_CDDEVICE_CONTROLLER_CONTRACTID },
  { NULL }
};
