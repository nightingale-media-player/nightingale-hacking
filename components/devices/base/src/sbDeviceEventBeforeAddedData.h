...
class sbDeviceEventBeforeAddedData : public sbIDeviceEventBeforeAddedData
{
public:
  NS_DECL_ISUPPORTS
  NS_DECL_SBIDEVICEEVENTBEFOREADDEDDATA

  nsresult Init(sbIDevice *aDevice);

  static nsresult CreateEventBeforeAddedData(
                    sbIDevice *aDevice,
