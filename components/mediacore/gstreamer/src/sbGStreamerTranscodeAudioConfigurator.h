...
public:
  ...
  FORWARD_TO_BASE(GetUseMuxer, (bool *aUseMuxer), aUseMuxer)
  ...
  FORWARD_TO_BASE(GetUseVideoEncoder, (bool *aUseVideoEncoder), aUseVideoEncoder)
  ...
  FORWARD_TO_BASE(GetUseAudioEncoder, (bool *aUseAudioEncoder), aUseAudioEncoder)
