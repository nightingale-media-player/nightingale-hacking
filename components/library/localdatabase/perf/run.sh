...
PERF_TESTS="guidarray guidarray_multisort guidarray_distinct guidarray_default_view guidarray_library_enumerate guidarray_search guidarray_search_distinct"
