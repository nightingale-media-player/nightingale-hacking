...
/**
 * Register the Nightingale string transform service component.
 */
...
/**
 * Unregister the Nightingale string transform service component.
 */
...
NS_IMPL_NSGETMODULE(NightingaleIntlModule, components)
