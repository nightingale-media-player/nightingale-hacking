...
//------------------------------------------------------------------------------
//
// Nightingale media management job
//
//------------------------------------------------------------------------------
//------------------------------------------------------------------------------
 ...
 * \brief Nightingale Media Management Job Definitions.
 */

//------------------------------------------------------------------------------
//
// Nightingale media management job imported services.
//
//------------------------------------------------------------------------------
...
//
// Nightingale media management job component defs.
//

#define SB_MEDIAMANAGEMENTJOB_CLASSNAME "Nightingale Media Management Job"
...
// Preference keys
#define PREF_MMJOB_INTERVAL     "nightingale.media_management.library.scan.interval"
#define PREF_MMJOB_LOCATION     "nightingale.media_management.library.folder"
#define PREF_MMJOB_COPYFILES    "nightingale.media_management.library.copy"
#define PREF_MMJOB_MOVEFILES    "nightingale.media_management.library.move"
#define PREF_MMJOB_RENAMEFILES  "nightingale.media_management.library.rename"
#define PREF_MMJOB_ENABLED      "nightingale.media_management.library.enabled"

//------------------------------------------------------------------------------
//
// Nightingale media management job defs.
//
//------------------------------------------------------------------------------
