...
#define SB_PREF_MEDIA_MANAGER_ROOT     "nightingale.media_management.library."
...
#define SB_CATEGORY_MEDIA_MANAGER_FILE_NAME_PROPERTIES "nightingale-media-manager-file-name-properties"
#define SB_CATEGORY_MEDIA_MANAGER_DIRECTORY_NAME_PROPERTIES "nightingale-media-manager-directory-name-properties"
...
#define SB_MEDIAMANAGEMENTSERVICE_CLASSNAME \
  "Nightingale Media Management Service"
