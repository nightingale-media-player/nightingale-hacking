...
#define NIGHTINGALE_SECURITYMIXIN_CONTRACTID                 \
  "@getnightingale.com/remoteapi/security-mixin;1"
#define NIGHTINGALE_SECURITYMIXIN_CLASSNAME                  \
  "Nightingale Remote Security Mixin"
#define NIGHTINGALE_SECURITYMIXIN_CID                        \
