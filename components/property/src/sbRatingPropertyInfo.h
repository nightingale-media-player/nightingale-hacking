...
#define NS_FORWARD_SBIPROPERTYINFO_OVERRIDE_RATING(_to) \
...
class sbRatingPropertyInfo : public sbNumberPropertyInfo,
                             public sbIClickablePropertyInfo
{
public:
  NS_DECL_ISUPPORTS_INHERITED
  NS_FORWARD_SBIPROPERTYINFO_OVERRIDE_RATING(sbNumberPropertyInfo::);
