...
#ifndef __sbBitratePropertyUnitConverter_H__
#define __sbBitratePropertyUnitConverter_H__

#include "sbPropertyUnitConverter.h"

class sbBitratePropertyUnitConverter : public sbPropertyUnitConverter {
public:
...
#endif // __sbBitratePropertyUnitConverter_H__
