...
#ifndef __SBDUMMYPROPERTYINFO_H__
#define __SBDUMMYPROPERTYINFO_H__
...
class sbDummyPropertyInfo : public sbPropertyInfo, 
                            public sbIDummyPropertyInfo
{
public:
...
#endif /* __SBDUMMYPROPERTYINFO_H__ */
