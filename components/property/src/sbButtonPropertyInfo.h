...
#ifndef __SBBUTTONPROPERTYINFO_H__
#define __SBBUTTONPROPERTYINFO_H__
...
#define NS_FORWARD_SBIPROPERTYINFO_OVERRIDE_BUTTON(_to) \
...
class sbButtonPropertyInfo : public sbPropertyInfo,
                             public sbIButtonPropertyInfo
{
public:
...
#endif /* __SBBUTTONPROPERTYINFO_H__ */
