...
sbPlaylistsource::sbPlaylistsource()
{
  ...
  NS_ASSERTION(!gPlaylistPlaylistsource, "Playlistsource initialized more than once!");
...
{
  LOG("sbPlaylistsource::GetQueryResult\RefName = %x\n_retval = %x\n", RefName, _retval);
  METHOD_SHORTCIRCUIT;
  *_retval = nsnull;
