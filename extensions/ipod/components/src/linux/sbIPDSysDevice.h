...
private:
  ...
  //   mDeviceUDI               Device HAL library UDI.
  //   mMediaPartUDI            Device media partition HAL library UDI.
  //

  nsCOMPtr<nsIPropertyBag>      mProperties;
  sbLibHalCtx*                  mSBLibHalCtx;
  nsCString                     mDeviceUDI;
  nsCString                     mMediaPartUDI;
  ...
  nsresult GetMountPath(nsAString& aMountPath);
