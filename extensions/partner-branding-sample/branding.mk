...
DISTRIBUTION_VERSION_WIN = 1.0.$(SB_BUILD_NUMBER).0

DISTRIBUTION_INSTALLER_NAME = $(SB_BRAND_SHORT_NAME)-$(DISTRIBUTION_VERSION).exe
...
SB_BRAND_FULL_NAME_INTERNAL = PartnerCo
...
DISTRIBUTION_APP_STUB = $(SB_BRAND_SHORT_NAME).exe
DISTRIBUTION_APP_STUB_COMMENTS = $(SB_BRAND_FULL_NAME) is based on The Mozilla Xulrunner Stub loader.
DISTRIBUTION_APP_ICON = partner.ico
DISTRIBUTION_APP_ICON_MAC = partner.icns
...
DISTRIBUTION_DEFINES += \
   ...
   -DDISTRIBUTION_VERSION_WIN="$(DISTRIBUTION_VERSION_WIN)" \
   -DDISTRIBUTION_INSTALLER_NAME="$(DISTRIBUTION_INSTALLER_NAME)" \
...
SB_BRANDING_DEFINES += \
   ...
   -DSB_BRAND_FULL_NAME_INTERNAL="$(SB_BRAND_FULL_NAME_INTERNAL)" \
   -DSB_BRAND_VENDOR_NAME="$(SB_BRAND_VENDOR_NAME)" \
   -DSB_VENDOR="$(SB_BRAND_VENDOR_NAME)" \
   -DSB_TRADEMARKS="$(SB_TRADEMARKS)" \
   -DSB_BRAND_TRADEMARKS="$(SB_BRAND_TRADEMARKS)" \
