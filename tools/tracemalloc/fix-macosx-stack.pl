...
# 
# For some reason the original version produced snapshots in a 
# format that was not compatible with Mozilla's histogram.pl
# and diff.pl tools.
#
# Please check for upstream changes.
#
